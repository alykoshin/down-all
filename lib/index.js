...
var Downloader = function(options) {
   ...
   * @private
   */
  self._downloadOne = function(linkObj) {
    ...
    var filepath = path.join(options.dest, linkObj.path, linkObj.name);
  ...
  self.download = function(linkObjs) {
